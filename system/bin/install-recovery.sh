#!/system/bin/sh
if ! applypatch -c EMMC:/dev/block/platform/13540000.dwmmc0/by-name/RECOVERY:26442016:fee3a5544febc686962934543aa6c3a90abfac0d; then
  applypatch EMMC:/dev/block/platform/13540000.dwmmc0/by-name/BOOT:21127456:7e94bd3ba37291da2a6708e7295cc49ec5cff562 EMMC:/dev/block/platform/13540000.dwmmc0/by-name/RECOVERY fee3a5544febc686962934543aa6c3a90abfac0d 26442016 7e94bd3ba37291da2a6708e7295cc49ec5cff562:/system/recovery-from-boot.p && log -t recovery "Installing new recovery image: succeeded" || echo 454 > /cache/fota/fota.status
else
